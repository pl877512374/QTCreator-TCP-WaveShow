...
QT_MOC_LITERAL(1, 11, 7), // "sigDraw"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11), // "sigWaveDraw"
QT_MOC_LITERAL(4, 32, 7), // "double*"
QT_MOC_LITERAL(5, 40, 7), // "sigConn"
QT_MOC_LITERAL(6, 48, 13), // "connect_false"
QT_MOC_LITERAL(7, 62, 8) // "slotConn"

    },
    "WorkThread\0sigDraw\0\0sigWaveDraw\0double*\0"
    "sigConn\0connect_false\0slotConn"
};
...
void WorkThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigDraw((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->sigWaveDraw((*reinterpret_cast< double*(*)>(_a[1])),(*reinterpret_cast< double*(*)>(_a[2]))); break;
        case 2: _t->sigConn((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->connect_false(); break;
        case 4: _t->slotConn((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::sigDraw)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (WorkThread::*_t)(double * , double * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::sigWaveDraw)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkThread::sigConn)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void WorkThread::sigDraw(int _t1)
{
...
// SIGNAL 1
void WorkThread::sigWaveDraw(double * _t1, double * _t2)
{
...
// SIGNAL 2
void WorkThread::sigConn(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
